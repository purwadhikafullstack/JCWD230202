...
const product = async () => {
	await db.product.bulkCreate([
		...
		// Batas Category 3
		{
			...
			description:
				"Susu UHT nabati lokal dari kacang mede pertama di Indonesia, Arummi Cashew Milk bisa menjadi alternatif baru yang jauh lebih creamy tidak kalah dengan susu sapi. Terbuat dari kacang mede pilihan yang kaya akan mineral dan vitamin yang baik untuk kesehatanmu. Rendah lemak, Arummi Cashew Milk hanya mengandung 100 kkal per sajiannya. Arummi Cashew Milk bisa dinikmati langsung dan lebih enak dalam kondisi dingin. Bisa juga digunakan dalam berbagai resep, termasuk kopi, smoothies, es krim, hingga masakan kesukaanmu. \n KOMPOSISI: Air, Kacang Mede Pasta (6%), Gula (Mengandung Pengawet Sulfit), Premiks Vitamin dan Mineral, Pengemulsi Nabati Mono dan Digliserida Asam Lemak, Penstabil Nabati, Garam, Perisa Sintetik Kacang Mede, Penstabil (Dinatrium Fosfat), Perisa Sintetik Vanilla (Mengandung Pewarna Alami Karamel I, dan Antioksidan Asam Askorbat). MENGANDUNG ALLERGEN Bersertifikat HALAL, BPOM RI MD 466628031166.Susu UHT nabati lokal dari kacang mede pertama di Indonesia, Arummi Cashew Milk bisa menjadi alternatif baru yang jauh lebih creamy tidak kalah dengan susu sapi. Terbuat dari kacang mede pilihan yang kaya akan mineral dan vitamin yang baik untuk kesehatanmu. Rendah lemak, Arummi Cashew Milk hanya mengandung 100 kkal per sajiannya. Arummi Cashew Milk bisa dinikmati langsung dan lebih enak dalam kondisi dingin. Bisa juga digunakan dalam berbagai resep, termasuk kopi, smoothies, es krim, hingga masakan kesukaanmu. \n KOMPOSISI: Air, Kacang Mede Pasta (6%), Gula (Mengandung Pengawet Sulfit), Premiks Vitamin dan Mineral, Pengemulsi Nabati Mono dan Digliserida Asam Lemak, Penstabil Nabati, Garam, Perisa Sintetik Kacang Mede, Penstabil (Dinatrium Fosfat), Perisa Sintetik Vanilla (Mengandung Pewarna Alami Karamel I, dan Antioksidan Asam Askorbat). MENGANDUNG ALLERGEN Bersertifikat HALAL, BPOM RI MD 466628031166. \n CARA PENYIMPANAN: Shelf life 9 bulan. Setelah dibuka, dianjurkan untuk dimasukkan ke kulkas dan segera dihabiskan dalam 3-4 hari. \n CARA PENYIMPANAN: Shelf life 9 bulan. Setelah dibuka, dianjurkan untuk dimasukkan ke kulkas dan segera dihabiskan dalam 3-4 hari.",
		},
		{
