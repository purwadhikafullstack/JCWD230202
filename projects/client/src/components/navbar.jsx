...
export default function NavigationBar(props) {
	...
	return (
		<>
			<div className="grid grid-cols-12 hidden fixed py-6 px-8 shadow-md max-w-screen w-full bg-[#0095DA] z-50">
				<button
			...
			<div className="grid grid-cols-12 lg:hidden fixed py-6 px-8 shadow-md max-w-screen w-full bg-[#0095DA] z-50">
				<button
					onClick={() => navigate("/home")}
					className="hidden lg:block col-span-3 font-mandalaFont font-extrabold text-xl text-white xl:text-4xl"
				>
